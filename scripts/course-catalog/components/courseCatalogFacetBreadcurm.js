import { courseCatalogFacetBreadcrumb } from '../course-catalog-controller/controllers.js';
...
export const renderCourceCatalogFacetBreadcurm = () => {
  ...
  courseCatalogFacetBreadcrumb.state.facetBreadcrumbs.forEach((value) => {
  ...
  button.addEventListener('click', () => {
    courseCatalogFacetBreadcrumb.deselectAll();
  });

  if (courseCatalogFacetBreadcrumb.state.hasBreadcrumbs) {
